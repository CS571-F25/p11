            ...
            >
                ...
                {watched.length === 0 ? (
                    <div className="text-center text-gray-500 mt-12">
                        <p className="text-xl">No movies watched yet</p>
                        <p className="mt-2">Start adding movies you've watched!</p>
                    </div>
                ) : (
                        ...
                        {watched.map((movie) => (
                            ...
                            >
                                <div className="relative aspect-[2/3] rounded-lg">
                                    ...
                                    {/* Overlay on hover */}
                                    <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-70 transition-all duration-300 flex items-center justify-center opacity-0 group-hover:opacity-75">
                                        <button
